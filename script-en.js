      ...
      function initTheme() {
          ...
          // apply theme
          document.body.classList.add(savedTheme || 'theme-1');
      ...
      // Restore dark mode FIRST (cleaner UX)
      const isDark = localStorage.getItem('darkMode') === 'true';
...
// - Closes when:
  ...
  // 2. Overlay is clicked
    ...
    // <---- language switcher toggle from English to Arabic ---->
    ...
    // <-------------------- Scroll down arrow ---------------->
      ...
      function openPDF() {
        window.open('Profile-EN/Dr-Merfat-Alardawi-Resume-en.pdf', '_blank');
      }
